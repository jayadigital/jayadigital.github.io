$(function(){$.fn.hasAttr=function(e){var t=this.attr(e);if(typeof t!==typeof undefined&&t!==false)return $(function() {
  ...
  $.fn.materialForm = function() {
    ...
    this.find("input, textarea").each(function() {
      if (e($(this))) {
        ...
        $(this).attr("id", n);
        var r = $(this)
        .wrap("<div class='material-input'></div>")
        .parent();
    ...
    this.find("select").each(function(e) {
      ...
      var i = $(this)
      .wrap("<div class='material-select'></div>")
      .parent();
      if (n == "checkbox") {
        r += "[]";
